public class ArraySlotAccess {
    ...
    public static void main(String[] args) {
        ...
        // Put a number in each slot of the array, one at a time.
        arr[0] = 6;
        arr[1] = 7;
        arr[2] = 8;

        // Display those values one at a time.
        System.out.println("Values: " + arr[0] + " " + arr[1] + " " + arr[2]);

        /////////////////////////////////////
        // Put a random number 1-100 in each array slot, one at a time.
        ...
        //////////////////////////////////////
        // This one is silly but try to understand it.
        int m = 0;
        ...
        //////////////////////////////////////
        // This is even more silly but works.
        int n = 0;
