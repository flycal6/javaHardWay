public class RandomNumbers {
    public static void main( String[] args) {
        ...
        rps = Math.random();
        if (rps < 0.3333333) { // true 1/3 of the time
